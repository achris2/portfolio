...
export default function Project({
    ...
    return (
        ...
        >
        <section
            className="bg-slate-50 max-w-[42rem] border border-slate-300/[5] rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] group-even:pl-8 hover:bg-slate-200 transition">
