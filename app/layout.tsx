...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <div className="absolute top-0 z-[-10] h-screen w-screen rotate-180 transform
                       bg-white bg-[radial-gradient(60%_120%_at_50%_50%,hsla(180,65%,55%,0)_0,rgba(130,175,255,0.2)_100%)]
                       ">
